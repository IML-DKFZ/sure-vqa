...
def prepare_data(args):
    ...
    for question_df in tqdm(all_questions.values()):
        ...
        question_df["subject_gender"] = question_df.apply(map_patient_gender, args=(patient_metadata,), axis=1)
        question_df["subject_anchor_age"] = question_df.apply(map_anchor_age, args=(patient_metadata,), axis=1)
        question_df["subject_anchor_year_group"] = question_df.apply(map_anchor_year_group, args=(patient_metadata,), axis=1)
        question_df["subject_ethnicity"] = question_df.apply(map_ethnicity, args=(admissions,), axis=1)
