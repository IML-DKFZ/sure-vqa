...
def select_questions_balanced(cfg):
    set_seed(cfg.seed)
    dataset = cfg.dataset
    ...
    for score in range(1, 6):
        ...
        num_ratings_2.append(len(scores_df.loc[scores_df["mistral_score"] == score]))
    json_file_path = cfg.dataset_dir / "validate.json"
    output_file_path = cfg.output_dir / f"rater_study_{answer_type.lower()}_balanced.json"
